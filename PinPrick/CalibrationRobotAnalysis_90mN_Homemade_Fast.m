...
%Param.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PeakThreshold = 0.20; %valeur de seuil de detection de pic
...
for s = 1:length(CalibrationFilesName)
        ...
        title('Calibration of the 90 mN homemade pinprick device')
...
savetable('CalibrationHomemadePinPrick_90mN_Fast',DataFiles,l);
