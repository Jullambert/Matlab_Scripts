...
%Param.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PeakThreshold = 0.03; %valeur de seuil de detection de pic
...
StartCycleMean = 0;
StopCycleMean = StartCycleMean + 1000;
...
% Params the calib analysis of the datas from the 24 of february 2015 :
...
%         DataFiles.Fz_std{end+1,1} = std(Fz(NumCycle(1)+StartCycleMean:NumCycle(1)+StopCycleMean,s)); %std(Fz(NumCycle(1)+StartCycleMean:NumCycle(1)+StopCycleMean));
        ...
        title('Calibration of the 90 mN homemade pinprick device - Skin')
...
savetable('Results_CalibrationHomemadePinPrick_90mN_Slow_Chicken2',DataFiles,l);

filename = 'Results_BartPaper_96mN_Slow_Transducer.mat';
save(filename)
