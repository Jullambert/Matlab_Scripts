...
% Peak Detection
[ValPeaks1, NumCycle1] = findpeaks(Filtred_Fz1,'MINPEAKHEIGHT',PeakThresholdF2);
[ValPeaks2, NumCycle2] = findpeaks(Filtred_Fz2,'MINPEAKHEIGHT',PeakThresholdF2);
...
MeanForcePinPrickG1 = mean(MeanForceG1)
StdForcePinPrickG1 = std(MeanForceG1)

MeanForcePinPrickBN = mean(MeanForceBN)
StdForcePinPrickBN = std(MeanForceBN)

MeanForcePinPrickBN1 = mean(MeanForceBN1)
StdForcePinPrickBN1 = std(MeanForceBN1)
...
plot(X1,Filtred_Fz1)
hold on
plot(NumCycle1,ValPeaks1,'r*')
G(2)=subplot(2,1,2);
plot(X2,Filtred_Fz2)
hold on
plot(NumCycle2,ValPeaks2,'r*')
linkaxes(G,'x')
