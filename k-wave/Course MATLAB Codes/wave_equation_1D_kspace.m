% Script to solve the 1D homogeneous wave equation using a k-space scheme,
% where the spatial derivatives are calculated using a Fourier collocation
% spectral method, and time integration is performed using a dispersion
% corrected second-order accurate finite-difference scheme.
%
...
for n = 1:Nt
    ...
    p_np1 = 2*p_n - p_nm1 ...
        + dt^2 * c0.^2 * real(ifft( -kappa.^2 .* kx.^2 .* fft(p_n)));
