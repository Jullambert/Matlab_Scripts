...
switch VoltagePP
    ...
    case 1.2
        ...
        switch UltrasoundBurstFrequency 
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 2150/1000000;
        end 
    
    case 1
        DistanceTransducteurHydrophone = 4.64%5.4; %[mm]
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 50/1000000; %3300/1000000;
            case 350000
                HydrophoneSensitivity = 0.99;
                PeakThreshold_Hydrophone = 2400/1000000;
            case 500000
    ...
    case 0.8
        ...
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 2140/1000000;
            case 350000
                HydrophoneSensitivity = 0.99;
                PeakThreshold_Hydrophone = 2100/1000000;
            case 500000
    ...
    case 0.6
        ...
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 1950/1000000; %2200 ou 2300
            case 350000
                HydrophoneSensitivity = 0.99;
                PeakThreshold_Hydrophone = 2100/1000000;
            case 500000
...
for iii=1:length(NameFile2);
    ...
    [a_2,b_2]=sort(stval_2);
        ...
        if stval_2(iii) == 250000
            if mod(iii,2)
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\250kHz')                
            else
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\250kHz_index')
            end
        elseif stval_2(iii) == 350000            
            if mod(iii,2)
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\350kHz')                
            else
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\350kHz_index')
            end
        else        
            if mod(iii,2)
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\500kHz')                
            else
                movefile(NameFile2{iii},'E:\Documents\Dropbox (NOCIONS)\jlambert\UCL_PhD\Setup\Mesures_Welcome\SessionAout\Positionnement_Angulaire\500kHz_index')
            end
        end
...
[Row,Col] = find(FWHM_Matrix,1,'first');
...
filenametosave = strcat('Resultats_Analyse_Data_SansCrane_AngleHydroTr_6_',num2str(NumberOfCycles),'Cycles_0',num2str(VoltagePP*10),'Vpp_',num2str(UltrasoundBurstFrequency/1000),'_kHz','.mat');
...
for x=1:size(v,1)
    for y=1:size(v,2)
        % Emis <=> T
        Burst_Tension_FunGen_Resampled(x,y,:) =  Tension_FunctionGen(x,y,3617:end);% 3617 car on coupe les 3616 premiers échantillons car ce n'est que du
...
% sin et cos quadrature) = phaseur de T
        ...
        %Recu <=> S
        Burst_Tension_Hydro_Resampled(x,y,:) =  Tension_Hydrophone(x,y,3617:end);% 3617 car on coupe les 3616 premiers échantillons car ce n'est que du
            % bruit et on s'arrange pour garder une puissance de 2 comme longueur de
            % vecteur!
