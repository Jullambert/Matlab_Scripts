...
switch VoltagePP
    ...
    case 1
        ...
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 3700/1000000; %2700/1000000; %50/1000000;3300/1000000;
            case 300000
...
for iii=1:length(NameFile2)
    ...
    idx_3=strfind(st,'_NumCycles_')+11;
    idx2_3=strfind(st,'.tdms')-1;
    stval_3(iii)=str2num(st(idx_3:idx2_3));
        switch stval_2(iii) 
            case 250000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\250kHz\200Cycles_index')
                        end                        
                end    
            case 300000   
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\300kHz\200Cycles_index')
                        end                         
                end 
                ...
                case 350000 
                    switch stval_3(iii)
                        case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\350kHz\200Cycles_index')
                        end 
                    end 
            ...
            case 400000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\400kHz\200Cycles_index')
                        end                         
                end 
            ...
            case 450000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\450kHz\200Cycles_index')
                        end                        
                end 
            ...
            case 500000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionAvril_Prob_Echo\500kHz\200Cycles_index')
                        end 
...
idx2_session=strfind(st,'1Vpp')-2;
% idx2_session=strfind(st,'Ancienne')-2;
session = NameData(idx_session:idx2_session);

idx_type=strfind(st,'Echo\')+5;
idx2_type=strfind(st,'NumCycles')+8;
type = NameData(idx_type:idx2_type);

idx_fichier=strfind(st,'kHz')+4;
idx2_fichier=strfind(st,'Cycles')+5;
fichier = NameData(idx_fichier:idx2_fichier(2));

idx_freq=strfind(st,'Cycles')+7;
