...
NumberSamplesRecorded =  30000;%20000; %pour 5 cycles avant sessionAvril (qui elle a été enregistrée avec 30000 points)
    ...
    case 1
        ...
        switch UltrasoundBurstFrequency 
            ...
            case 450000
                ...
                PeakThreshold_Hydrophone = 3800/1000000; %
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 3300/1000000; % 3500/1000000 ;2300 pour 5 cycles
        end
    case 0.8
...
for iii=1:length(NameFile2)
    ...
    idx2_2=strfind(st,'_NumCycles')-1;
    stval_2(iii)=str2num(st(idx_2(3):idx2_2));
    [a_2,b_2]=sort(stval_2);
    idx_3=strfind(st,'NumCycles_')+10;
    idx2_3=strfind(st,'.tdms')-1;
    stval_3(iii)=str2num(st(idx_3(3):idx2_3));
        switch stval_2(iii) 
            case 250000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\250kHz\200Cycles_index')
                        end                        
                end    
            case 300000   
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\300kHz\200Cycles_index')
                        end                         
                end 
                ...
                case 350000 
                    switch stval_3(iii)
                        case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\350kHz\200Cycles_index')
                        end 
                    end 
            ...
            case 400000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\400kHz\200Cycles_index')
                        end                         
                end 
            ...
            case 450000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\450kHz\200Cycles_index')
                        end                        
                end 
            ...
            case 500000
                switch stval_3(iii)
                    case 5
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\5Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\5Cycles_index')
                        end
                    case 10
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\10Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\10Cycles_index')
                        end                        
                    case 20 
                         if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\20Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\20Cycles_index')
                        end                       
                    case 50
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\50Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\50Cycles_index')
                        end                        
                    case 100 
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\100Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\100Cycles_index')
                        end                        
                    case 200
                        if mod(iii,2)
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\200Cycles')                
                        else
                            movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionMultipleNumCycles\500kHz\200Cycles_index')
                        end 
...
idx2_session=strfind(st,'Sans')-2;
% idx2_session=strfind(st,'Ancienne')-2;
session = NameData(idx_session:idx2_session);

idx_type=strfind(st,'NumCycles\')+10;
idx2_type=strfind(st,'1Vpp_')-2;
type = NameData(idx_type:idx2_type);

idx_fichier=strfind(st,'SansCrane')+10;
idx2_fichier=strfind(st,'kHz')-5;
fichier = NameData(idx_fichier:idx2_fichier);

idx_freq=strfind(st,'Cycles_bis')+11;
...
% sin et cos quadrature) = phaseur de T
        ...
        FFT_vecteur_Burst_Tension_Hydro(x,y,1:(NSamples/2)+1)= FFT_vecteur_Burst_Tension_Hydro(x,y,1:(NSamples/2)+1).*0; % Partie freq neg = à 0
