...
for iii=1:length(NameFile2)
    ...
    stval_2(iii)=str2num(st(idx_2:idx2_2));
    [a_2,b_2]=sort(stval_2);
        ...
        elseif stval_2(iii) == 300000            
            if mod(iii,2)
                movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\Tr2_1Vpp_200C_Sans_Table2\300kHz')                
            else
                movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\Tr2_1Vpp_200C_Sans_Table2\IndexFiles')
            end
        elseif stval_2(iii) == 350000            
            if mod(iii,2)
                movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\Tr2_1Vpp_200C_Sans_Table2\350kHz')                
            else
                movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\Tr2_1Vpp_200C_Sans_Table2\IndexFiles')
            end
