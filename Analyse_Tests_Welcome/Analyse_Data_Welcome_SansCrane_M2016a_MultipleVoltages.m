...
% 
% Last modif : 19/10/2016 - JL 
%Version with computation of the dimensions of the FWHM
%15/03/17 --> adding folder 300,400,450 kHz + switches related to those
%possibilities for case 1Vpp
% modif 7 april 2017 --> sort files according to frequency and number
% cycles
clc
clear all
...
%                 PeakThreshold_Hydrophone = 4100/1000000; %
%         end
        DistanceTransducteurHydrophone = 5.4 ;%(sessionJuillet_MultipleVoltages) %5.8;%(SessionAttenuation 20 cycles_1)%5.3; % ( SessionAttenuation 5)% 5.2;%(SessionAttenuation4 SansCrane)%5.74; %(SessionAttenuation3 SansCrane) 5.1; %(SessionAttenuation2 SansCrane)%5.6; %(SessionAttenuation1 SansCrane) %5.7; %(proto_Zero_Protection %10.6; %(protoMoinsDix)%5.4;%(pour proto Zero)%5.5 ;%(pour proto hors)%5.6;%(pour 20 Deg)%5.54; %%(pour10Deg)%5.6; %(pour5Deg);%5.3; %(pour-10)%5.24;%(pour0Deg) ;%5.28;%(pour -5deg)%5.54; %%(pour10Deg) %4.64; %5.4; %[mm] 5.6 pour nouvelle pièce d'alignement
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 4500/1000000; %2700/1000000; %50/1000000;3300/1000000;
            case 300000
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 4400/1000000;%3700/1000000; % 3500/1000000;2300 pour 5 cycles
        end
        
    case 1.8
        DistanceTransducteurHydrophone = 5.4 ;%(sessionJuillet_MultipleVoltages) ;
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 3850/1000000; %2700/1000000; %50/1000000;3300/1000000;
            case 300000
                HydrophoneSensitivity = 0.91;
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 4200/1000000;%3700/1000000; % 3500/1000000;2300 pour 5 cycles
        end
    ...
    case 1.6
        ...
        switch UltrasoundBurstFrequency 
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 4000/1000000;%3700/1000000; % 3500/1000000;2300 pour 5 cycles
        end
    ...
    case 1.4
        ...
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 3950/1000000; %2700/1000000; %50/1000000;3300/1000000;
            case 300000
                HydrophoneSensitivity = 0.91;
                PeakThreshold_Hydrophone = 3000/1000000; %
            case 350000
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 3900/1000000;%3700/1000000; % 3500/1000000;2300 pour 5 cycles
        end
    ...
    case 1.2
        DistanceTransducteurHydrophone = 5.4 ;%(sessionJuillet_MultipleVoltages) ;%6.34;%(SessionAttenuation 20 cycles_1)%5.3; % ( SessionAttenuation 5)% 5.2;%(SessionAttenuation4 SansCrane)%5.74; %(SessionAttenuation3 SansCrane) 5.1; %(SessionAttenuation2 SansCrane)%5.6; %(SessionAttenuation1 SansCrane) %5.7; %(proto_Zero_Protection %10.6; %(protoMoinsDix)%5.4;%(pour proto Zero)%5.5 ;%(pour proto hors)%5.6;%(pour 20 Deg)%5.54; %%(pour10Deg)%5.6; %(pour5Deg);%5.3; %(pour-10)%5.24;%(pour0Deg) ;%5.28;%(pour -5deg)%5.54; %%(pour10Deg) %4.64; %5.4; %[mm] 5.6 pour nouvelle pièce d'alignement
        switch UltrasoundBurstFrequency 
            case 250000
                HydrophoneSensitivity = 0.84;
                PeakThreshold_Hydrophone = 3850/1000000; %2700/1000000; %50/1000000;3300/1000000;
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 3600/1000000; % 3500/1000000;2300 pour 5 cycles
        end
    ...
    case 1
        ...
        switch UltrasoundBurstFrequency 
            ...
            case 500000
                HydrophoneSensitivity = 1.22;
                PeakThreshold_Hydrophone = 3500/1000000; % 3700/1000000; 3500/1000000;2300 pour 5 cycles
        end
    case 0.8
...
for iii=1:length(NameFile2)
    ...
    idx2_2=strfind(st,'Voltage')-2;
    stval_2(iii)=str2num(st(idx_2(2):idx2_2(3)));
    [a_2,b_2]=sort(stval_2);
    idx_3=strfind(st,'Voltage_')+8;
    idx3_2=strfind(st,'.tdms')-1;
    stval_3(iii)=str2num(st(idx_3(1):idx3_2));
    [a_3,b_3]=sort(stval_3);
    switch stval_2(iii) % switch sur frequence via nom du fichier
        case 250000
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\250kHz_index\2Vpp')
                    end
            end
        case 300000  
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\300kHz_index\2Vpp')
                    end
            end
        case 350000            
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\350kHz_index\2Vpp')
                    end
            end
        case 400000            
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\400kHz_index\2Vpp')
                    end
            end
        case 450000            
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\450kHz_index\2Vpp')
                    end
            end
        case 500000        
            switch stval_3(iii) % switch sur tension via nom fichier
                case 10
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\1Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\1Vpp')
                    end
                case 12
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\1_2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\1_2Vpp')
                    end
                case 14
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\1_4Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\1_4Vpp')
                    end
                case 16
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\1_6Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\1_6Vpp')
                    end
                case 18
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\1_8Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\1_8Vpp')
                    end
                case 20
                    if mod(iii,2)
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz\2Vpp')                
                    else
                        movefile(NameFile2{iii},'D:\data\jlambert\TFUS_Mesures_Welcome\SessionJuillet_MultipleVoltages\500kHz_index\2Vpp')
                    end
            end
    end
end
...
idx2_session=strfind(st,'Session1')-2;
% idx2_session=strfind(st,'Ancienne')-2;
session = NameData(idx_session:idx2_session);

idx_type=strfind(st,'Voltages\')+9;
idx2_type=strfind(st,'kHz')-5;
type = NameData(idx_type:idx2_type);

idx_fichier=strfind(st,'kHz\')+4;
idx2_fichier=strfind(st,'Vpp')+2;
fichier = NameData(idx_fichier:idx2_fichier);

idx_freq=strfind(st,'Session1')+9;
...
% if UltrasoundBurstFrequency == 250000
    ...
    disp(['La valeur max de l Isppa est de : ' num2str(max(max(Isppa(:,1:91)))) ' et est postionné au point : ' num2str(PositionX_maxIsppa) ' ' num2str(PositionY_maxIsppa)])
    [PositionX_maxIspta, PositionY_maxIspta] = find(Ispta==max(max(Ispta(:,1:91))));
    disp(['La valeur max de l Ispta est de : ' num2str(max(max(Ispta(:,1:91)))) ' et est postionné au point : ' num2str(PositionX_maxIspta) ' ' num2str(PositionY_maxIspta)])
    [PositionX_maxMI, PositionY_maxMI] = find(MI==max(max(MI(:,1:91))));
    disp(['La valeur max du MI est de : ' num2str(max(max(MI(:,1:91)))) ' et est postionné au point : ' num2str(PositionX_maxMI) ' ' num2str(PositionY_maxMI)])
    [PositionX_maxPi, PositionY_maxPi] = find(Pi==max(max(Pi(:,1:91))));
    disp(['La valeur max du Pi est de : ' num2str(max(max(Pi(:,1:91)))) ' et est postionné au point : ' num2str(PositionX_maxPi) ' ' num2str(PositionY_maxPi)])
    
% else
%     [PositionX_maxIsppa, PositionY_maxIsppa] = find(Isppa==max(max(Isppa)));
%     disp(['La valeur max de l Isppa est de : ' num2str(max(max(Isppa))) ' et est postionné au point : ' num2str(PositionX_maxIsppa) ' ' num2str(PositionY_maxIsppa)])
%     [PositionX_maxIspta, PositionY_maxIspta] = find(Ispta==max(max(Ispta)));
%     disp(['La valeur max de l Ispta est de : ' num2str(max(max(Ispta))) ' et est postionné au point : ' num2str(PositionX_maxIspta) ' ' num2str(PositionY_maxIspta)])
%     [PositionX_maxPi, PositionY_maxPi] = find(Pi==max(max(Pi)));
%     disp(['La valeur max du Pi est de : ' num2str(max(max(Pi))) ' et est postionné au point : ' num2str(PositionX_maxPi) ' ' num2str(PositionY_maxPi)])
%     [PositionX_maxMI, PositionY_maxMI] = find(MI==max(max(MI)));
%     disp(['La valeur max du MI est de : ' num2str(max(max(MI))) ' et est postionné au point : ' num2str(PositionX_maxMI) ' ' num2str(PositionY_maxMI)])
% end
...
save(filename3,'InitBurst','EndBurst','BurstHydrophone',...
    'TimeVector_BurstHydrophone','Pi','MI','TI','Isppa','Ispta','FWHM_Matrix')
...
figure;
subplot(5,1,1);
h1=plot(squeeze(Tension_Hydrophone(xindex-(2*xstep),101,:)),'k');
xlim([xmin xmax]);
ylim([ymin ymax]);
subplot(5,1,2);
h2=plot(squeeze(Tension_Hydrophone(xindex-xstep,101,:)),'k');
xlim([xmin xmax]);
ylim([ymin ymax]);
subplot(5,1,3);
h3=plot(squeeze(Tension_Hydrophone(xindex,101,:)),'k');
xlim([xmin xmax]);
ylim([ymin ymax]);
subplot(5,1,4);
h4=plot(squeeze(Tension_Hydrophone(xindex+xstep,101,:)),'k');
xlim([xmin xmax]);
ylim([ymin ymax]);
subplot(5,1,5);
h5=plot(squeeze(Tension_Hydrophone(xindex+2*xstep,101,:)),'k');
xlim([xmin xmax]);
ylim([ymin ymax]);
for i=101:-1:1;
    set(h1,'YData',squeeze(Tension_Hydrophone(xindex-(2*xstep),i,:)));
    set(h2,'YData',squeeze(Tension_Hydrophone(xindex-xstep,i,:)));
    set(h3,'YData',squeeze(Tension_Hydrophone(xindex,i,:)));
    set(h4,'YData',squeeze(Tension_Hydrophone(xindex+xstep,i,:)));
    set(h5,'YData',squeeze(Tension_Hydrophone(xindex+2*xstep,i,:)));
    pause(0.25);
end;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
xmin = 14000;
